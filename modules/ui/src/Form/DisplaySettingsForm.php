...
class DisplaySettingsForm implements FormBuilderInterface, FormSubmitInterface {
  ...
  public function buildForm($form, $form_state) {
    ...
    $form['separator_settings']['crumbs_separator'] = array(
      ...
      '#element_validate' => array('_crumbs_ui_validate_separator_xss'),
    );
  ...
  function submit(array $form, array &$form_state) {
    ...
    if ($this->submitCheckboxesChanged($form['theme_override_settings']['crumbs_override_theme_breadcrumb'])) {
   ...
   */
  private function submitCheckboxesChanged($element) {
